...
const CategoryProductList = ({ categoryName }) => {
  ...
  const fetchCategoryProducts = async () => {
    setLoading(true);
    try {
      // Pass the category name directly to the API function
      // The API function will handle decoding and encoding
      const response = await GlobalApi.getSingleCategory(categoryName);
      console.log("Fetched products for category:", decodedCategoryName, response?.data?.data); // Log response here
